...
class SphereTests {
    ...
    public void testFindIntersections() {
        ...
        assertEquals(1, result1.size(), "wrong number of points!");
        assertEquals(result1.get(0), new Point(1, -3/5d, -4/5d),
        ...
        Point q2 = new Point(1, -3 / 5d, -4 / 5d);
